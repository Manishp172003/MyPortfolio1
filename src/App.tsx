      ...
      {!isLoading && (
        <>
          ...
          <motion.div
            ...
            className="relative min-h-screen bg-deep-dark text-white overflow-hidden bg-grain select-none antialiased selection:bg-neon-purple selection:text-white" id="portfolio-app-root"
          >
